...
prop.table(table(pt$node_p2)) # 9% I1, 33% I2, 14% S1, 18% S2, 26% S3
  ...
  # further investigate catch-all category of I2s (19% & 33%!) 
  table(pt$dmethfin_p1[pt$node_p1 == "I2"])
    # method of delivery
    # 3 were 1=Spontaneous vaginal
    # 1,722 were 5=Cesarean without Trial Labor
  table(pt$dmethfin_p2[pt$node_p2 == "I2"]) 
    # method of delivery
    # 99 were 1=Spontaneous vaginal
    # 3 were 2=Forceps
    # 8 were 3=Vacuum
    # 1,719 were 5=Cesarean without Trial Labor
  # OK - these look like true I2s, except possibly the 113 vaginal births
  # could investigate 113 further if we want
